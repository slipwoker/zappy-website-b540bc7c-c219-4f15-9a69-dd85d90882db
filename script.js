    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Signature Massage – ALEX – מגע אישי ומרפא משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'b540bc7c-c219-4f15-9a69-dd85d90882db',
                    name: data.name || '',
                    email: data.email || '',
